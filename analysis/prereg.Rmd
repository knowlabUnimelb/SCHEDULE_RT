...
This document describes Experiment 1.
...
The optimal policy to minimize the time on any task is to complete shortest subtask first. We will determine whether participants converge to this optimal schedule. We expect greater optimality when participants have to complete the RDK task under a deadline.
...
Each participant will complete 10 no deadline scheduling trials and 30 deadline scheduling trials via a web browser.
...
We manipulated the coherence and direction of four RDK tasks and the deadline available for selection and completion of the four tasks on each trial. We additionally manipulated whether there was a deadline or not.
